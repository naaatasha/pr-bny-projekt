...
if ( !( isset( $woocommerce_loop['layout'] ) && ! empty( $woocommerce_loop['layout'] ) ) )
    $woocommerce_loop['layout'] = 'default';
...
if( $index = array_search( 'span2', $woocommerce_loop['li_class'] ) )
	$woocommerce_loop['li_class'][ $index ] = 'span3';
...
<li <?php post_class( $woocommerce_loop['li_class'] ); ?><?php if ( $woocommerce_loop['view'] == 'list' ) : ?> style="min-height: <?php echo $height; ?>px;"<?php endif; ?>>
    ...
    <div class="product-wrapper">
        ...
        <?php //if ( yit_get_option('shop-view-show-title') ): ?>
            <h3<?php echo $title_class ?>> <a href="<?php the_permalink() ?>"><?php the_title(); ?></a><?php if ( $woocommerce_loop['view'] == 'list' && yit_get_option( 'shop-view-show-rating' ) ) echo $product->get_rating_html(); ?></h3>
        <?php //endif ?>
