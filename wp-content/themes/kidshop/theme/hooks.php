...
add_action( 'yit_before_header', 'yit_decoration_header', 10 );
...
//add_action( 'yit_after_header', 'yit_slider_section', 9 );
add_action( 'yit_after_header', 'yit_page_meta' );
add_action( 'yit_after_header', 'yit_slogan', 20 );

add_action( 'yit_after_header', 'yit_map', 19 );
...
add_action( 'comment_form_top', create_function( '', 'echo "<hr class= \"title-line\">";' ) );

add_action( 'comment_form_top', create_function( '', 'echo "<div class=\"row-fluid\">";' ) );
add_action( 'comment_form', create_function( '', 'echo "</div>";' ) );

add_action( 'comment_form_before_fields', create_function( '', 'if ( ! function_exists("is_product") || ! is_product() ) { echo "<div class=\"span3 fields\">"; }' ) );
