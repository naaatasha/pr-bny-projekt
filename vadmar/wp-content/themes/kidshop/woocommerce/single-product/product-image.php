...
$is_fullscreen = yit_get_option('product-single-layout') == 'layout-2' ? true : false;
$size = 'shop_single';

// Fix for Woocommerce 2.2.x
if ( function_exists( 'yit_change_single_width' ) && version_compare( preg_replace( '/-beta-([0-9]+)/', '', $woocommerce->version ), '2.2', '>=' ) && $is_fullscreen ) {
