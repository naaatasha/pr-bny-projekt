...
?>
<div id="reviews" class="<?php if( $count > 0 ) echo 'with_reviews'?>"><?php
	...
	if ( have_comments() ) :
        ...
        //echo '<p class="add_review"><a href="#review_form" class="inline show_review_form button" title="' . __( 'Add Your Review', 'yit' ) . '">' . __( 'Add Review', 'yit' ) . '</a></p>';
...
<div id="review_form_wrapper" class="<?php if( $count > 0) echo 'with_reviews'; ?>"><div id="review_form">
...
<?php
	...
	$comment_form['comment_field'] .= '<p class="comment-form-comment"><label for="comment">' . __( 'Add Review', 'yit' ) . '</label><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true"></textarea></p>' . wp_nonce_field('woocommerce-comment_rating', '_wpnonce', true, false);
